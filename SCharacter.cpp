...
ASCharacter::ASCharacter()
{
	...
	OnHealthComp = CreateDefaultSubobject<USHealthComponent>(TEXT("HealthComp"));
...
void ASCharacter::BeginPlay()
{
	...
	OnHealthComp->OnHealthChanged.AddDynamic(this, &ASCharacter::OnHealthChanged);
